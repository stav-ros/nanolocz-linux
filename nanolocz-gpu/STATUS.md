...
Current card: NL-03
Status: done — ready for NL-10 or NL-50
...
| NL-03 | Typed core contracts | done | `nanolocz/core/types.py`; 43 type contract tests green; protocols with @runtime_checkable |
| NL-10–NL-17 | CPU core port | not_started | blocked by foundation (now unblocked) |
